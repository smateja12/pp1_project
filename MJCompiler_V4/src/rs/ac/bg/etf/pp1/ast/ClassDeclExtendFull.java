...
public class ClassDeclExtendFull extends ClassDecl {
    ...
    public ClassDeclExtendFull (BaseClassName BaseClassName, Type Type, VarDeclList VarDeclList, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclExtendFull(\n");
