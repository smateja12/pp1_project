...
public class StatementListOne extends StatementList {

    private Statement Statement;
    private StatementListTail StatementListTail;

    public StatementListOne (Statement Statement, StatementListTail StatementListTail) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementListOne(\n");
