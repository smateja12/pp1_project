...
public class ActParsDesignator extends DesignatorStmtParam {

    private FactorFuncCallBeginning FactorFuncCallBeginning;
    private ActualParameters ActualParameters;

    public ActParsDesignator (FactorFuncCallBeginning FactorFuncCallBeginning, ActualParameters ActualParameters) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsDesignator(\n");
